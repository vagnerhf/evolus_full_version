...
class Evolus extends MY_Controller {
    ...
    public function pesquisar()
    {
        ...
        $this->data['view'] = 'evolus/pesquisa';
    ...
    public function cadastrarEmitente()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(site_url('evolus/emitente'));
        } else {
    ...
    public function emails()
    {
        ...
        $this->data['configuration']['base_url'] = site_url('evolus/emails/');
    ...
    public function excluirEmail()
    {
        ...
        if ($id == null) {
            ...
            redirect(site_url('evolus/emails/'));
        }
    ...
    public function configurar()
    {
        ...
        $this->data['view'] = 'evolus/configurar';
    ...
    public function atualizarBanco()
    {
        ...
        return redirect(site_url('evolus/configurar'));
    }
